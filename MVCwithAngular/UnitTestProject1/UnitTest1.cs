...
namespace testProject
{
    ...
    public class MyUnitTestNS
    {
        ...
        public static HospitalDbContext CreateDbContext()
        {
            ...
            optionsBuilder.UseSqlServer("Connectionstring: HospitalManagement");
        ...
        public void TestAPIPost()
        {
            ...
            List<Patient> pdtos = new List<Patient>();
            pdtos.Add(new Patient() { name = "Shiv", address = "Mumbai", email = "shiv@yahoo.com" });
            pdtos.Add(new Patient() { name = "", address = "Mumbai1", email = "shiv1@yahoo.com" });
            pdtos.Add(new Patient() { name = "ddd", address = "Mumbai1", email = "shiv1yahoo.com" });
